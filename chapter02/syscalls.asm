...
.eqv    ReadString      8       # a0 = address of buffer, a1 = maximum characters to read; n/a
.eqv    Sbrk            9       # a0 = amount of memory to get; a0 = address of memory block
.eqv    Exit            10      # n/a; n/a
...
.eqv    Close           57      # a0 = file descriptor
.eqv    Read            63      # a0 = file descriptor, a1 = address of buffer, a2 = maximum lengt; a0 = count of characters or -1 on error
.eqv    Write           64      # a0 = file descriptor, a1 = address of buffer, a2 = maximum length; a0 = count of characters
.eqv    Open            1024    # a0 = null terminated path, a1 = flags; a0 = file descriptor or -1 on error -- flags: 0-read, 1-write, 9-append
